...
class GiftCardResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'concepto' => $this->venta->source_id == Venta::SOURCE_TIENDA_NUBE ? 'Tienda Nube' : ( $this->venta->source_id == Venta::SOURCE_CANJE ? 'Canje' : ( $this->venta->source_id == Venta::SOURCE_INVITACION ? 'Invitaci&oacute;n' : 'Venta' )),
